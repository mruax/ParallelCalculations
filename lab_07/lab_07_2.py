            ...
            for x, y, is_finished in zip(agents_x, agents_y, finished):
                if 0 <= x < self.width and 0 <= y < self.height:
                    if is_finished:
                        ...
                        # n_active = 1 -> темно-красный [0.5, 0, 0]
                        # n_active = 100 -> ярко-красный [1, 0, 0]
...
def experiment_1_single_process(maze_path: str, n_agents: int = 100):
    ...
    algo.visualize_progress('/mnt/user-data/outputs/experiment1_progress.png')
...
if __name__ == "__main__":
    ...
    print(f"  Время до первого успеха: {time_1proc:.2f}с")
    ...
    print("=" * 70)
    print("\nКритерий остановки: первый агент достигает выхода")
    print("\nСохраненные файлы:")
